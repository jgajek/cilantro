...
- folds proven constant predicate helpers and analyzes dispatcher CFG/stack state;
...
- detects Reactor method stubs/JIT hooks and refuses unsafe restoration;
...
resources, entry point, strong-name state, branches, exception regions, and an
independent reload are checked before emission. Reactor helper types and
